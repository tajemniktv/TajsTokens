...
public enum QuotaAccountAttribution { Unattributed, ProviderVerified, UserAsserted }

/// <summary>User-owned association, never a replacement for a source's AccountKey.</summary>
public sealed record RolloutAccountAssociation(string Id, string Provider, string Profile,
    string SourceIdentity, string SessionId, DateTimeOffset FromUtc, DateTimeOffset ThroughUtc,
    string AccountKey, DateTimeOffset AssertedAtUtc)
{
