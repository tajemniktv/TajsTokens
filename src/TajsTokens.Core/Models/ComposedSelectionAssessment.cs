...
public sealed record ComposedSelectionAssessment(bool Passed, bool RequiresStrictReplay, int Outcomes,
    int EvaluationBlocks, int IncumbentPairs, double? BlockBalancedLoss,
    double? BlockBalancedIncumbentLoss, double? BlockBalancedPaceLoss, IReadOnlyList<string> Reasons)
{
