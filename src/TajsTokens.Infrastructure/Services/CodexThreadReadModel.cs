// Taj's Tokens | CodexThreadReadModel.cs
...
public sealed class CodexThreadReadModel : ICodexThreadReadModel
{
    ...
    {
        return _sourceReader.BrowseThreadsAsync(query, cancellationToken);
    }
    ...
    public Task<CodexThreadSearchResult> SearchThreadsAsync(
        ...
        CancellationToken cancellationToken)
    {
        return _sourceReader.SearchThreadsAsync(search, take, cancellationToken);
    }
    ...
    public async Task<CodexThreadReadResult> ReadThreadAsync(
        ...
        CancellationToken cancellationToken)
    {
        CodexThreadReadResult sourceResult = await _sourceReader.ReadThreadAsync(threadId, cancellationToken);
        ...
        CodexThreadStateReadModel state = CodexThreadReadModelPolicy.Reconcile(sourceResult.StateSources);
