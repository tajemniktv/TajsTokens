// Taj's Tokens | ProviderParsingTests.cs
...
public sealed class ProviderParsingTests
{
    ...
    public void TokscaleModels_ParsesDisjointBucketsWithoutDoubleCounting()
    {
        ...
        TokenUsage usage = Assert.Single(TokscaleProvider.ParseModelUsageJson(json, DateTimeOffset.UnixEpoch));
    ...
    public void TokscaleHourly_AcceptsEntriesAndNumericHourLabels()
    {
        ...
        TokenTimeBucket bucket = Assert.Single(TokscaleProvider.ParseHourlyJson(json));
    ...
    {
        string commandLine = ExternalProcess.BuildWindowsCommandLine(
            "tokscale",
    ...
    public void ExternalProcess_ConcreteExecutablePathBypassesShellExpansion()
    {
        ...
        ProcessStartInfo startInfo = ExternalProcess.CreateStartInfo(
    ...
    public void CodexRateLimits_MapsWindowsByDurationNotPrimaryPosition()
    {
        ...
        QuotaSnapshot snapshot = Assert.Single(CodexAppServerQuotaProvider.ParseRateLimitsResponse(json, DateTimeOffset.UnixEpoch));
    ...
    public void CodexRateLimits_PrefersCodexEntryFromRateLimitsByLimitId()
    {
        ...
        IReadOnlyList<QuotaSnapshot> snapshots = CodexAppServerQuotaProvider.ParseRateLimitsResponse(json, DateTimeOffset.UnixEpoch);
